...
public class Day2 {
    ...
    private int totalWrappingPaper = 0;
    ...
    public void fileRead(BufferedReader reader) {
        try {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                Present present = new Present(Integer.parseInt(dimension[0]), Integer.parseInt(dimension[1]), Integer.parseInt(dimension[2]));
                totalWrappingPaper += present.getNeedPaper();
                totalRibbon += present.getNeedRibbon();
            }
        } catch (IOException e) {
            e.printStackTrace();
        }
